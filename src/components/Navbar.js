            ...
            <div
              ...
              <div className="hidden sm:block sm:ml-auto">
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="text-red-500 text-lg hover:bg-red-600 hover:text-white px-3 py-2 rounded-md font-medium">Explore</a>
<a
                    href="#"
                    className="text-red-500 text-lg hover:bg-red-600 hover:text-white px-3 py-2 rounded-md font-medium">My Space</a>
                  <a
                    href="#"
                    className="text-red-500 text-lg hover:bg-red-600 hover:text-white px-3 py-2 rounded-md font-medium">About</a>
                  <a
                    href="#"
                    className="text-red-500 text-lg hover:bg-red-600 hover:text-white px-3 py-2 rounded-md font-medium">Login</a>
        ...
        <div className="sm:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <a
              href="#"
              className="text-red-500 hover:bg-red-700 hover:text-white block px-3 text-center py-2 rounded-md text-base font-medium"
              aria-current="page">Dashboard</a>

            <a
              to="/register"
              className="text-red-500 hover:bg-red-700 hover:text-white block px-3 text-center py-2 rounded-md text-base font-medium">Team</a>
            <a
              href="#"
              className="text-red-500 hover:bg-red-700 hover:text-white block px-3 text-center py-2 rounded-md text-base font-medium">Projects</a>
            <a
              href="#"
              className="text-red-500 hover:bg-red-700 hover:text-white block px-3 text-center py-2 rounded-md text-base font-medium">Calendar</a>
          </div>
        </div>
        {/* End Mobile Menu */}
      </div>
