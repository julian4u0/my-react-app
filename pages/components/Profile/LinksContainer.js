...
const Link = function (props) {
  ...
  return (
    <div className="flex flex-row w-full">
      <div className="flex flex-row  justify-between py-2 my-2 rounded-l-lg bg-grayc w-full ">
        <div className="flex flex-col px-2 text-gray-900">
          <input
            className="p-1 placeholder-gray-400 bg-grayc focus:outline-none text-gray-300 focus:text-white focus:bg-gray-700 font-semibold"
            type="text"
            placeholder="Title"
            name="titleValue"
            value={titleValue}
          ...
          />
          <input
            className="p-1 bg-grayc placeholder-gray-400 focus:outline-none text-gray-300 focus:text-white focus:bg-gray-700 font-semibold"
            placeholder="Url"
            type="text"
            name="urlValue"
            value={urlValue}
      ...
      <div className="flex flex-col justify-between p-3 my-2 rounded-r-lg bg-gray-600  text-white font-semibold">
        <div
          onClick={onMove}
...
class LinksContainer extends React.Component {
  ...
  render() {
    return (
      <div className="flex pt-4  bg-grayb items-center flex-col">
        <div className="flex flex-row">
          <button
            onClick={this.addLink}
            className="bg-green-700 rounded-l-lg hover:bg-green-600 text-white font-semibold p-3 my-2  shadow"
          >
            Add New Link
          </button>
          <button
            onClick={this.addLink}
            className="bg-green-700 border-l rounded-r-lg hover:bg-green-600 text-white font-semibold p-3 my-2  shadow"
          >
            <DownArrow />
          </button>
        </div>
